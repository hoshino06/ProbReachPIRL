...
PINN_SAMPLE_MODE=${PINN_SAMPLE_MODE:-uniform}
PINN_REPLAY_FRACTION=${PINN_REPLAY_FRACTION:-1.0}
PINN_REPLAY_JITTER=${PINN_REPLAY_JITTER:-0.0}
PINN_EXPAND_JITTER_INITIAL=${PINN_EXPAND_JITTER_INITIAL:-0.0}
PINN_EXPAND_JITTER_FINAL=${PINN_EXPAND_JITTER_FINAL:-0.15}
PINN_EXPAND_CENTER=${PINN_EXPAND_CENTER:-500000}
PINN_EXPAND_SHARPNESS=${PINN_EXPAND_SHARPNESS:-1.0e-5}
PINN_EXPAND_TIME_BASE=${PINN_EXPAND_TIME_BASE:-local}
